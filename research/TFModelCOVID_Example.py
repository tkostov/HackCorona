...
DangerSpread = 3.0
TotalRateToDie = 0.1
ChanceToDie = TotalRateToDie * Covid.sigmoid(NumAge, DangerPoint,
...
ChanceHospital = TotalRateToHospital * Covid.sigmoid(NumAge, DangerPoint,
                                                     DangerSpread)  # Age-dependent chance to die in intensive care
...
ChanceInfection = InfectionRateTotal * Covid.gaussian(TimeOnly, MeanInfectionDate,
...
Par = Covid.cPar(
    ...
    quarantineTrace=Covid.deltas([[30, 0.3], [50, 0.9]], SimTimes)
